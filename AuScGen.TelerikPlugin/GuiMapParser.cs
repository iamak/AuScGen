...
namespace AuScGen.TelerikPlugin
{
	...
	public class GuiMapParser
	{
		...
		public Dictionary<string, Guimap> LoadMap(string filePath)
		{
		...
		/// </summary>
		/// <param name="objCollection">The GUI object collection.</param>
		...
		/// </exception>
		public string GetElementValue(Dictionary<string, Guimap> objCollection, string logicalName)
		{
			Guimap tempMap = null;
			string elementValue = string.Empty;
			try
			{
				if (objCollection.ContainsKey(logicalName))
				{
					tempMap = objCollection[logicalName];
